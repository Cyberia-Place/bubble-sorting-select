...
// // DECLARO EL DICCIONARIO COMO VARIABLE GLOBAL PARA USARLO EN VARIAS FUNCIONES
// var dict = {};
...
//             if (symbol == "♦" || symbol == "♥") {
//                 let card = `<div class="card my-3 rounded cardpoker mx-2">
...
//                 document.querySelector(".container").innerHTML += card;
//             }
//             //   HAGO UN PAR KEY-VALUE, DONDE LA KEY ES EL HTML Y EL VALUE ES LA LETRA QUE USO PARA EL SORTING BUBBLE
//             dict[card] = letter;
//         }
//     }
// }
